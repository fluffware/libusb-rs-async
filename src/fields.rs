...
///
/// ```no_run
/// use libusb_async::{Direction,RequestType,Recipient};
///
/// libusb_async::request_type(Direction::In, RequestType::Standard, Recipient::Device);
/// ```
